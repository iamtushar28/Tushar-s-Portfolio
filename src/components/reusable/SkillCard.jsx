...
const SkillCard = ({ icon, name, showCheck = true, hiddenOnMobile = false }) => (
  <button
    className={`${hiddenOnMobile ? 'hidden lg:flex' : 'flex'} w-full h-14 p-4 text-lg font-[400] text-white hover:bg-white border border-white rounded-lg justify-between items-center group transition-all duration-200 cursor-pointer`}>
